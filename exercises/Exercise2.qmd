...
In this exercise, you'll build a short report about a dataset you've seen
before. This is a practical example for putting together the core skills from
the course: Quarto, useful reporting packages, formulas and model objects,
interpretation, and the programming habits you've been developing. Optional
bonus questions let you try bootstrapping or power simulation after the main
report is working.
