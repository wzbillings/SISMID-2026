...
neo <- tibble::tibble(
  t.1 = c(36.1, 36.4, 35.8, 36.0, 36.3, 35.9, 36.2, 36.5, 36.1, 36.0),
  t.2 = c(36.6, 36.7, 36.1, 36.4, 36.8, 36.2, 36.5, 36.9, 36.4, 36.3)
)
...
In this small neonatal temperature example, is there a statistically significant difference in body temperature between time point one (t.1) and time point two (t.2)?
...
The $\beta$s from a logistic regression are on the log-odds scale. For most applied reports, exponentiate them to get odds ratios.
